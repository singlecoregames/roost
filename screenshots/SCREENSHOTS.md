...
| `11`~`20-viewer-*.png`, `08-viewers.png`, `09-viewers-fbx.png` | 코드(player.gd)·마크다운·Aseprite·이미지(docs/world-map.png)·FBX·오디오·Godot 씬·HTML(docs/site)·PDF(4쪽 이미지 덱)·JSON(levels·[0]·tuning 펼침)·CSV(16행)·폰트(Roboto) 뷰어 | "파일을 한 곳에서 편하게" 타일 12장(전체 비율, 누르면 확대 보기) |
